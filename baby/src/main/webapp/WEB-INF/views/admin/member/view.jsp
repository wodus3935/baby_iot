...
<body>
	...
	<div id="container">
		...
		<div class="row">
			...
			<div class="col-md=10">
			<a href="../changePassword/${member.userId}" class="btn btn-danger">비밀번호수정</a>
			<a href="../edit/${member.userId}" class="btn btn-primary">회원정보수정</a>
			<a href="../delete/${member.userId}" class="btn btn-primary">삭제</a>
